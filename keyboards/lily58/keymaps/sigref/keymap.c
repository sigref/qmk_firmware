...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        CKC_GRV_ESC,        KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      /**/                    KC_6,    KC_7,    KC_8,    KC_9,   KC_0,            TD(TD_MIN_EQ),
    ...
    [_GAME] = LAYOUT(
        ...
        KC_TAB,             KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,             /**/           KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,            KC_BSLS,
        KC_LCTL,            KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             /**/           KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN,         KC_QUOT,
        KC_LSFT,            KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_M,  /**/ KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT, TD(TD_SLS_BSLS), KC_RSFT,
                                KC_LALT, KC_LGUI, LT(_GRYPH, KC_LNG2),   KC_SPC,  /**/ KC_ENT,   LT(_MOVE, KC_LNG1), KC_BSPC, KC_RALT
    ),

    [_GRYPH] = LAYOUT(
        CKC_GRV_ESC,        _______, _______, _______, _______, _______,          /**/          _______, _______, _______, _______, _______, _______,
